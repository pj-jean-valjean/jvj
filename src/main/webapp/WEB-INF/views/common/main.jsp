...
어원은 일본어의 쇼쿠판(食パン)이다. 일본에서는 미술 디자인을 할 때 그림 지우는 용도로 사용하는 빵을 케시판(消しパン: 지움빵)이라 부르는데, 이에 대응하여 실제로 먹는 빵을 쇼쿠판(食パン: 먹음빵)이라 부르던 데서 나왔다는 설이 대표적이다. </p>
            ...
            <div data-aos="fade-up" data-aos-duration="800">
                <div class="store">
                    ...
                    <div class="store-ex" style="margin-left:126px">
                        <h1>매커롱</h1>
                        <p>매커롱을 누가 어디에서 처음 만들었는지는 정확히 알려져 있지 않다. 중세 유럽에서 전해졌다고도 하며, 이탈리아의 수도원에서 만들었다고도 한다. 공식적인 기록은 1533년 이탈리아 메디치 가문의 카트린 드 메디시스(Catherine de Médicis)가 프랑스의 앙리 2세와 결혼하게 되면서부터다. 그녀와 함께 프랑스로 갔던 이탈리아의 요리사들을 통해 매커롱뿐만 아니라 이탈리아의 식문화가 프랑스에 전파되었다고 한다.</p>
                        <h1>35,000원</h1>
                        <div class="moreBtn">+ 더보기</div>
                    </div>
